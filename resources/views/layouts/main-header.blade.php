                                        ...
                                        <div class="menu-header-content bg-primary text-right">
                                            <div class="d-flex">
                                                ...
                                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                                     <a href="#" id="markAllread">تعين قراءة الكل</a>
                                                </span>
                                            </div>
                                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="unreadNotifications_count">عدد الإشعارات الغير مقروءة {{ auth()->user()->unreadNotifications->count() }}  </p>
                                        </div>
                                        <div class="main-notification-list Notification-scroll" id="unreadNotifications">
                                            @foreach(auth()->user()->unreadNotifications as $notification)
                                                <a  href="{{ url('InvoicesDetails') }}/{{ $notification->data['id'] }}"  class="d-flex p-3 border-bottom">
