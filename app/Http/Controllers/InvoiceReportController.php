    ...
    public function Search_invoices(Request $request){
        ...
        if ($rdio == 1) {
            ...
            if ($request->type && $request->start_at =='' && $request->end_at =='') {
                ...
                $type = $request->type;
                return view('reports.invoiceReport',compact('type'))->withDetails($invoices);
            }
            ...
            // في حالة تحديد تاريخ استحقاق
                ...
                return view('reports.invoiceReport',compact('type','start_at','end_at'))->withDetails($invoices);
...
// في البحث برقم الفاتورة
            ...
            return view('reports.invoiceReport')->withDetails($invoices);
